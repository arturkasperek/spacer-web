  ...
  for (let i = 0; i < vCount; i++, idx3 += 3, idx4 += 4, idx12 += 12) {
    ...
    if (w0 !== 0) {
      ...
      if (boneIdx < boneCount) {
        ...
        const px = infPos[idx12], py = infPos[idx12 + 1], pz = infPos[idx12 + 2];
        const m0 = bonePalette[bi], m1 = bonePalette[bi + 1], m2 = bonePalette[bi + 2];
        const m4 = bonePalette[bi + 4], m5 = bonePalette[bi + 5], m6 = bonePalette[bi + 6];
        const m8 = bonePalette[bi + 8], m9 = bonePalette[bi + 9], m10 = bonePalette[bi + 10];
        const m12 = bonePalette[bi + 12], m13 = bonePalette[bi + 13], m14 = bonePalette[bi + 14];
        ...
        if (infNorm) {
          const nx = infNorm[idx12], ny = infNorm[idx12 + 1], nz = infNorm[idx12 + 2];
    ...
    if (w1 !== 0) {
      ...
      if (boneIdx < boneCount) {
        const bi = (boneIdx << 4);
        const pOff = idx12 + 3;
        const px = infPos[pOff], py = infPos[pOff + 1], pz = infPos[pOff + 2];
        const m0 = bonePalette[bi], m1 = bonePalette[bi + 1], m2 = bonePalette[bi + 2];
        const m4 = bonePalette[bi + 4], m5 = bonePalette[bi + 5], m6 = bonePalette[bi + 6];
        const m8 = bonePalette[bi + 8], m9 = bonePalette[bi + 9], m10 = bonePalette[bi + 10];
        const m12 = bonePalette[bi + 12], m13 = bonePalette[bi + 13], m14 = bonePalette[bi + 14];
        ...
        if (infNorm) {
          const nx = infNorm[pOff], ny = infNorm[pOff + 1], nz = infNorm[pOff + 2];
