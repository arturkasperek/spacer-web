...
export function buildNpcWorldIndices(world: World | null) {
  ...
  if (!world) return { waypointPosIndex: wpIndex, waypointDirIndex: wpDirIndex, vobPosIndex: vobIndex, vobDirIndex };
      ...
      if (!vobIndex.has(kk)) {
        ...
        if (rotArray && typeof rotArray.size === "function" && typeof rotArray.get === "function") {
          ...
          if (m.length === 9) {
            ...
            const isIdentity = m[0] === 1 && m[1] === 0 && m[2] === 0 &&
                              m[3] === 0 && m[4] === 1 && m[5] === 0 &&
                              m[6] === 0 && m[7] === 0 && m[8] === 1;
  ...
  return { waypointPosIndex: wpIndex, waypointDirIndex: wpDirIndex, vobPosIndex: vobIndex, vobDirIndex };
}
